...
# 2 - Lister les numéros des appels entrants.
...
# 3 - Lister les numéros des appels sortants.
...
# 4 - Calculer la durée totale des appels entrants en format hh:mm:ss.
...
# 5 - Calculer la durée totale des appels sortants en format hh:mm:ss.
...
# 6 - Trouver le numéro avec la durée d'appel la plus longue.
